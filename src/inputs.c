...
{
	fprintf(stderr, "Number of Coders: %d\n", inputs->number_of_coders);
	fprintf(stderr, "Time to Burnout: %d\n", inputs->time_to_burnout);
	fprintf(stderr, "Time to Compile: %d\n", inputs->time_to_compile);
	fprintf(stderr, "Time to Debug: %d\n", inputs->time_to_debug);
	fprintf(stderr, "Time to Refactor: %d\n", inputs->time_to_refactor);
	fprintf(stderr, "Number of Compiles Required: %d\n",
		inputs->number_of_compiles_required);
	fprintf(stderr, "Dongle Cooldown: %d\n", inputs->dongle_cooldown);

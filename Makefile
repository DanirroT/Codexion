...
SRC =	$(SRC_DIR)main.c\
		...
		$(SRC_DIR)lst_functs.c\
		$(SRC_DIR)queue_man.c\
		$(SRC_DIR)ft_trashs.c\
		$(SRC_DIR)time.c\
		$(SRC_DIR)safe_utils.c\
		$(SRC_DIR)utils_lib.c\
		$(SRC_DIR)misc_utils.c\
		$(SRC_DIR)ft_out.c\
...
VALGRIND = valgrind --tool=memcheck --track-origins=yes --leak-check=full --show-leak-kinds=all
...
# valid
#       nb bout com deb ref nbc dcd sk
INPUTS = 3 100 200 200 200 3 100 edf
# INPUTS = 100 8000 200 200 200 3 1000 fifo
# invalid
#       nb bout com deb ref nbc dcd sk
# INPUTS = 3 100 200 200 200 3 100 fifo

test: $(NAME) db/
	@echo "          nb bout com deb ref nbc dcd sk"
	-./$(NAME) $(INPUTS) 2> db/debugging.txt

memtest: $(NAME) db/
	-$(VALGRIND) ./$(NAME) $(INPUTS) 2> db/debugging_mem.txt
...
# 	$(TESTING) ./$(NAME) 3 10000 200 200 200 3 100 edf 2> dbm/debugging_3se.txt

# 	@echo "\nTesting with 3 Coders, no Burnout FIFO, long cooldown\n"
# 	$(TESTING) ./$(NAME) 3 12000 200 200 200 3 1000 fifo 2> dbm/debugging_3lf.txt
# 	@echo "\nTesting with 3 Coders, no Burnout EDF, long cooldown\n"
# 	$(TESTING) ./$(NAME) 3 14000 200 200 200 3 1000 edf 2> dbm/debugging_3le.txt

# 	@echo "\nTesting with 3 Coders, Burnout! FIFO\n"
# 	$(TESTING) ./$(NAME) 3 100 200 200 200 3 100 fifo 2> dbm/debugging_3bf.txt
# 	@echo "\nTesting with 3 Coders, Burnout! EDF\n"
# 	$(TESTING) ./$(NAME) 3 100 200 200 200 3 100 edf 2> dbm/debugging_3be.txt

# 	@echo "\nTesting with 25 Coders, no Burnout FIFO\n"
# 	$(TESTING) ./$(NAME) 25 8000 200 200 200 3 100 fifo 2> dbm/debugging_25sf.txt
# 	@echo "\nTesting with 25 Coders, no Burnout EDF\n"
# 	$(TESTING) ./$(NAME) 25 10000 200 200 200 3 100 edf 2> dbm/debugging_25se.txt

# 	@echo "\nTesting with 25 Coders, no Burnout FIFO, long cooldown\n"
# 	$(TESTING) ./$(NAME) 25 8000 200 200 200 3 1000 fifo 2> dbm/debugging_25lf.txt
# 	@echo "\nTesting with 25 Coders, no Burnout EDF, long cooldown\n"
# 	$(TESTING) ./$(NAME) 25 8000 200 200 200 3 1000 edf 2> dbm/debugging_25le.txt

# 	@echo "\nTesting with 25 Coders, Burnout! FIFO\n"
# 	$(TESTING) ./$(NAME) 25 100 200 200 200 3 100 fifo 2> dbm/debugging_25bf.txt
# 	@echo "\nTesting with 25 Coders, Burnout! EDF\n"
# 	$(TESTING) ./$(NAME) 25 100 200 200 200 3 100 edf 2> dbm/debugging_25be.txt
